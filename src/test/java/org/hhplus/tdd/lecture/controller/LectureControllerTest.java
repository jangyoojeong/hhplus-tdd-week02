...
public class LectureControllerTest {
    ...
    @Test
    @DisplayName("[성공] 특강_신청_API_테스트")
    public void applyForLectureTest_특강_신청_API_테스트 () throws Exception {

        // Given
        LectureApplyRequest request = new LectureApplyRequest(2L, scheduleId);
    ...
    @Test
    @DisplayName("[성공] 특강_목록_조회_API_테스트_2건의_목록이_정상적으로_조회된다")
    public void getAllLecturesTest_특강_목록_조회_API_테스트_2건의_목록이_정상적으로_조회된다 () throws Exception {
        ...
        assertThat(actualResponse).isEqualTo(expectedResponse.toArray(new LectureGetResponse[1]));
    }


    @Test
    @DisplayName("[성공] 특강_신청_완료_여부_조회_API_테스트")
